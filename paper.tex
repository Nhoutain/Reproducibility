...
\newcommand{\urlqjump}{http://www.cl.cam.ac.uk/netos/qjump/nsdi2015}
\newcommand{\urlqj}[1]{\urlqjump/#1.html}
\newcommand{\hrefqj}[3][black]{\href{\urlqj{#2}}{\color{#1}{#3}}}%


\begin{figure}[t]
 \centering
 \hrefqj{figure5}{\includegraphics[width=0.9\columnwidth]{stat/bar_mail/bar_mail-all.png}}
 \caption{caption}
 \label{f:eval-multi-app}
\end{figure}


\begin{figure}
    \centering
    \href{http://nhoutain.github.io/Reproducibility/}{\includegraphics[width=5cm]{stat/bar_mail/bar_mail-all.png}}
    \caption{oo}
\end{figure}
